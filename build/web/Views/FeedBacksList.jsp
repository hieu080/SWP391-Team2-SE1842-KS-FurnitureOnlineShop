        ...
        <div class="full-height" style="display: flex;">
            <div style="width: 18%; height: 100%; background-color: #39435c; padding-top: 0px;">
                ...
                <div style="display: flex; width: 100%; color: white; margin: 10px;">
                    ...
                    <p style="margin-left: 10px;">Hello, sangmo17</p><br>
                </div>
            ...
            <div style="width: 70%; height: 100%; background-color: #ffffff; padding-top: 0px;">

                <div style="width: 100%; height: 50px;display: flex; padding-left: 20px; font-size: 15px;">
                ...
                <div style="width: 100%; height: 650px;display: flex; padding-left: 20px; font-size: 15px;">
                ...
                <div style="width: 100%; background-color: #ffffff; height: 30px;">
