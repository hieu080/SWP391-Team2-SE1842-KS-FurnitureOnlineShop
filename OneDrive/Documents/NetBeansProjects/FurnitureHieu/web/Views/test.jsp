<%-- 
    Document   : test
    Created on : May 30, 2024, 11:35:13 PM
    Author     : HELLO
--%>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 pro-loop col-4">
                        <div class="product-block product-resize site-animation single-product">
                            <div class="product-img fade-box">
                                <c:if test="${not empty requestScope.saleOffList}">
                                    <c:forEach items="${requestScope.saleOffList}" var="saleoff">
                                        <c:if test="${not empty saleoff and saleoff.product_id == product.id}">
                                            <c:choose>
                                ...
                                <a href="#" title="${product.name}" class="image-resize">
