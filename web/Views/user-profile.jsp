...
<html lang="en">
    ...
    <body>
                        ...
                        <c:choose>
                            <c:when test="${not empty sessionScope.customer}">
                                <div class="signup-form" style="display: flex; flex-direction: column; align-items: center; justify-content: center;"><!--sign up form-->
                                    ...
                                    <form action="${pageContext.request.contextPath}/UserProfileServlet" method="post" enctype="multipart/form-data">
        ...
        <script>
            ...
            document.getElementById('fbimg').addEventListener('change', function (event) {
                var file = event.target.files[0];
                if (file) {
                    var reader = new FileReader();
                    reader.onload = function (e) {
                        document.getElementById('curAvt').src = e.target.result;
                    };
