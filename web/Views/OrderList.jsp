        ...
        <form method="post">
            ...
            <div class="dropdown" style="display:flex; justify-content: space-between;">
                <button class="dropbtn">
                    SẮP XẾP THEO <i class="fa-solid fa-caret-down"></i>
                </button>
            ...
            <div class="search-container">
                ...
                <div class="group-filter">
                    <div class="filter_group_title dropdown-filter">
                        <span>Trạng thái</span><span class="icon-controls"><i class="fa fa-chevron-down"></i></span>
                    </div>
                    ...
                    <button><a href="${pageContext.request.contextPath}/OrderListServlet?clearfilter=yes">Bỏ lọc</a></button>
            </div>
        </form>
                            ...
                            <div class="button-order">
                                <c:choose>
                                    ...
                                    <c:when test="${order.status == 'Confirmed'}">
                                        <button class="btn btn-danger btn-block" style="margin-left:200px">Confirmed</button>
                                    </c:when>
                                    <c:otherwise>
