                                ...
                                <c:forEach items="${listcartdetail}" var="cartdetail" varStatus="status">
                                    <tr class="list-item">
                                        ...
                                        <td class="item">
                                            ...
                                            <div><span class="pro-quantity-view">${cartdetail.cartItem.quantity}</span> </div>
                                                    ...
                                                    <c:if test="${saleoff.product_id == cartdetail.product.id}">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${saleoff.getSaleoffvalue() == 0}">
                                                                <span class="pro-price-view">${cartdetail.product.price}₫</span>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <span class="pro-price-view">${cartdetail.product.price - cartdetail.product.price * saleoff.getSaleoffvalue() / 100}₫</span>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </c:if>
                                                </c:forEach>
